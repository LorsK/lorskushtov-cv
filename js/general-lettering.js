...
function HeadlineHandler() {
  ...
  this.init = function() {
    ...
    slides.each(function() {
      ...
      jQuery(this)
        .children('.atxt_hl, .atxt_sl')
        .textillate(textillate_options);
    });
    var $ = jQuery;
...
(function($, window, document, undefined) {
  ...
  window.displayWidth = function(comparison, value) {
    if (
      ...
      if (jQuery.isNumeric(value)) {
        ...
        return window.matchMedia('(' + comparison + ':' + value + 'px)')
          .matches;
      } else {
  ...
  var resizeHandler = function() {
    if (
      Main.headlineHandler &&
      typeof Main.headlineHandler.update === 'function'
    ) {
  ...
  $document.ready(function() {
    ...
    $body.on('click touchstart', function(e) {
      ...
      if ($('#nav-button').is(':visible') && $('#nav').is(':visible')) {
        if (
          !$t.is('#nav-button') &&
          !$t.closest('#nav-button').length &&
          !$t.closest('#nav').length
        ) {
          e.preventDefault();
          $('#nav-button').click();
        }
